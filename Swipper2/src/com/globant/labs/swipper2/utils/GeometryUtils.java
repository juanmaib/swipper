...
public class GeometryUtils {
	...
	public static Point locationToRadarPoint(Place place, LatLngBounds bounds, int size_x, int size_y,
			double azimuth) {
	...
	public static Point locationToRealityPoint(Place place, LatLngBounds bounds, int size_x, int size_y,
			double azimuth) {
